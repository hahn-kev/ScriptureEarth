// DEPRECATED — the SQLite/mysqldump path is superseded by the consolidated JSON
// dump (scripts/extract.mjs, which reads data/scripture.json). Kept for reference
// and as a fallback only; not part of any default build. See scripts/README-dump.md.
//
