...
# Vendored verbatim from https://github.com/dumblob/mysql2sqlite (MIT License).
# Converts a MySQL/MariaDB `mysqldump` (phpMyAdmin flavour) into SQLite-dialect
# SQL on stdout. Do not edit — re-vendor from upstream if an update is needed.
# Invoked by scripts/convert_dump.mjs. See scripts/README-dump.md.
